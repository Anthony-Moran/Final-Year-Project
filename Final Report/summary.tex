The main objective of this project is to build a web app that allows users to play chess over a network, with an emphasis on online communication over long distances.
